...
<body style="overflow-y: hidden;">
    ...
    <div class="tile-area tile-area-scheme-dark fg-white" style="height: 100%; max-height: 100% !important;">
        ...
        <div class="tile-area-controls">
            ...
            <a href="view_allocatedscripts.php" class="square-button no-border bg-darkBlue"><span class="mif-exit"></span></a>
        </div>
        ...
        <div class="tile-group double">
            ...
            <div class="tile-container">
                ...
                <div class="tile bg-darkGreen fg-white" data-role="tile" onclick="document.location.href='upload_answerscript.php'">
                    <div class="tile-content iconic">
                        <span class="icon mif-profile"></span>
                    
                    </div>
                    <span class="tile-label">Upload Answer Script</span>
                </div>
                
                <div class="tile bg-darkTeal fg-white" data-role="tile" onclick="document.location.href='valuate_answerscript.php'">
                    <div class="tile-content iconic">
                        <span class="icon mif-profile"></span>
                    
                    </div>
                    <span class="tile-label">Valuate Answer Script</span>
                </div>
                
                <div class="tile bg-darkCobalt fg-white" data-role="tile" onclick="document.location.href='view_allocatedscripts.php'">
                    <div class="tile-content iconic">
                        <span class="icon mif-finder"></span>
                    
                    </div>
                    <span class="tile-label">View Allocated Scripts</span>
                </div>
                
                <div class="tile bg-darkViolet fg-white" data-role="tile" onclick="document.location.href='view_answerscript.php'">
                    <div class="tile-content iconic">
                        <span class="icon mif-display"></span>
                    
                    </div>
                    <span class="tile-label">View Answer Script</span>
                </div>
