<?php
	...
	echo '<table  class="table table-hover table-bordered" id="sampleTable" width="90%">
		...
		$sql= "select student.regno,student.name,course.name,answerscript.sem,mark,result.status from result,course,student,answerscript where result.scriptNo = answerscript.scriptNo and course.courseId = answerscript.courseId and student.regno = answerscript.studentId and result.status='published'";
