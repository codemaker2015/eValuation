...
<html>
  <head>
    ...
    <title>College Registration :: E-Valuation</title>
  </head>
  <body>
    ...
    <section class="login-content">
      ...
      <div class="col-md-6">
          <div class="tile">
            <h3 class="tile-title">College Registration</h3>
            <div class="tile-body">
              <form class="form-horizontal" action="college_register2.php" method="POST">
                ...
                <div class="form-group row">
                  ...
                  <div class="col-md-8">
                      <textarea class="form-control" id="uaddress" name="uaddress" placeholder="Enter address" required></textarea>
                  </div>
                </div>                  
		<div class="form-group row">
