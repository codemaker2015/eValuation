...
<head lang="en">
    ...
    <meta name="description" content="E Valuation Developed by Vishnu Sivan, VSoft Technologies">
    <meta name="keywords" content="HTML, CSS, JS, JavaScript, framework, metro, front-end, frontend, web development">
    <meta name="author" content="Sergey Pimenov and Metro UI CSS contributors">

    <link rel='shortcut icon' type='image/x-icon' href='favicon.ico' />
    <title>E-Valuation :: Dashboard</title>
...
<body style="overflow-y: hidden;">
    ...
    <div class="tile-area tile-area-scheme-dark fg-white" style="height: 100%; max-height: 100% !important;">
        <h1 class="tile-area-title">E-Valuation</h1>
        <div class="tile-area-controls">
            ...
            <a href="view_faculty.php" class="square-button no-border bg-darkBlue"><span class="mif-exit"></span></a>
        </div>
        ...
        <div class="tile-group double">
            ...
            <div class="tile-container">
                ...
                <div class="tile bg-darkGreen fg-white" data-role="tile" onclick="document.location.href='approve_faculty.php'">
                    <div class="tile-content iconic">
                        <span class="icon mif-profile"></span>
                    
                    </div>
                    <span class="tile-label">Approve Faculty</span>
                </div>
                
                <div class="tile bg-darkTeal fg-white" data-role="tile" onclick="document.location.href='approve_student.php'">
                    <div class="tile-content iconic">
                        <span class="icon mif-profile"></span>
                    
                    </div>
                    <span class="tile-label">Approve Student</span>
                </div>
                
                <div class="tile bg-darkCobalt fg-white" data-role="tile" onclick="document.location.href='allocate_answerscript.php'">
                    <div class="tile-content iconic">
                        <span class="icon mif-finder"></span>
                    
                    </div>
                    <span class="tile-label">Allocate Answerscript</span>
                </div>
                
                <div class="tile bg-darkViolet fg-white" data-role="tile" onclick="document.location.href='publish_result.php'">
                    <div class="tile-content iconic">
                        <span class="icon mif-display"></span>
                    
                    </div>
                    <span class="tile-label">Publish Result</span>
                </div>
                
            </div>
        </div>
        <div class="tile-group double">
            <span class="tile-group-title">Registrations</span>
            <div class="tile-container">

                <div class="tile bg-yellow fg-white" data-role="tile" id="ctrl_button12" data-on-click="document.location.href='college_register.php'">
                    <div class="tile-content iconic">
                        <span class="icon mif-school"></span>
                    </div>
                   
                    <span class="tile-label">Add College</span>
                </div>
     
                <div class="tile bg-darkOrange fg-white" data-role="tile" id="ctrl_button24" data-on-click="document.location.href='course_register.php'">
                 
                    <div class="tile-content iconic">
                        <span class="icon mif-books"></span>
                    </div>
                    
                    <span class="tile-label">Add Course</span>
                </div>
                <div class="tile bg-red fg-white" data-role="tile" id="ctrl_button3" data-on-click="document.location.href='subject_register.php'">
                 
                    <div class="tile-content iconic">
                        <span class="icon mif-books"></span>
                    </div>
                   
                    <div class="tile-label">Add Subject</div>
                </div>	
            </div>
        </div>

        <div class="tile-group double">
            <span class="tile-group-title">Views</span>
   
                <div class="tile bg-magenta fg-white" data-role="tile" id="ctrl_button10" data-on-click="document.location.href='view_college.php'">
                 
                    <div class="tile-content iconic">
                        <span class="icon mif-school"></span>
                    </div>
                    
                    <span class="tile-label">View College</span>
                </div>
               
                <div class="tile bg-steel fg-white" data-role="tile" id="ctrl_button22" data-on-click="document.location.href='view_course.php'">
                 
                    <div class="tile-content iconic">
                        <span class="icon mif-books"></span>
                    </div>
                   
                    <span class="tile-label">View Course</span>
                </div>
            
                <div class="tile bg-darkOrange fg-white" data-role="tile" id="ctrl_button22" data-on-click="document.location.href='view_subject.php'">
                 
                    <div class="tile-content iconic">
                        <span class="icon mif-books"></span>
                    </div>
                   
                    <span class="tile-label">View Subject</span>
                </div>
            
                <div class="tile bg-yellow fg-white" data-role="tile" id="ctrl_button10" data-on-click="document.location.href='view_faculty.php'">
                 
                    <div class="tile-content iconic">
                        <span class="icon mif-user"></span>
                    </div>
                    
                    <span class="tile-label">View Faculty</span>
                </div>
            
                <div class="tile bg-cyan fg-white" data-role="tile" id="ctrl_button10" data-on-click="document.location.href='view_student.php'">
                 
                    <div class="tile-content iconic">
                        <span class="icon mif-user"></span>
                    </div>
                    
                    <span class="tile-label">View Student</span>
                </div>
                <div class="tile bg-taupe fg-white" data-role="tile" id="ctrl_button10" data-on-click="document.location.href='view_result.php'">
                 
                    <div class="tile-content iconic">
                        <span class="icon mif-books"></span>
                    </div>
                    
                    <span class="tile-label">View Result</span>
                </div>
        ...
        <div class="tile-group double">
            <span class="tile-group-title">Others</span>
               ...
               <div class="tile bg-crimson fg-white" data-role="tile" id="ctrl_button1" data-on-click="document.location.href='view_feedback.php'">
                 
                    <div class="tile-content iconic">
                        <span class="icon mif-file-text"></span>
                    </div>
                   
                    <span class="tile-label">Feedback</span>
                </div>
